  ...
  useEffect(() => {
    ...
    gantt.locale = {
      ...
      labels: {
        ...
        month: "Mes",
        year: "Año",
        section_categoria: "Categoría",
        section_HrsxJor: "Horas por Jornada",
        section_JorxDia: "Jornadas por día",
        section_JorExt: "Jornadas Extra",
      }
    };

    gantt.config.columns = [
      { name: "text", label: "Categoría", width: 145, tree: true },
      { name: "HrsxJor", label: "Hrs x Jor", align: "center", width: 80 },
      { name: "JorxDia", label: "Jor x dia", align: "center", width: 80 },
    ...
    gantt.config.lightbox.sections = [
      ...
      { name: "HrsxJor", label: "Jornada", height: 40, map_to: "HrsxJor", type: "textarea" },
      { name: "JorxDia", label: "Jornadas por dia", height: 40, map_to: "JorxDia", type: "textarea" },
      { name: "JorExt", label: "Jornadas Extra", height: 40, map_to: "JorExt", type: "textarea" },
